...
import { ArrowRight, Zap, Github, Coffee, Palette, Feather, Layers, ClipboardList, Copy, MessageSquare, Briefcase, TrendingUp } from "lucide-react";
    ...
    >
      ...
      >
        <div className="flex items-center justify-center text-gray-800">
          ...
          <Link href="/templates">
            <motion.button
              className="flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-full shadow-xl text-lg font-semibold hover:from-gray-800 hover:to-gray-700 transition-all duration-300 group"
